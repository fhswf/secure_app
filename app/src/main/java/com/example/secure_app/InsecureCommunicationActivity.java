...
public class InsecureCommunicationActivity extends AppCompatActivity {
    ...
    PageAdapter_insecure_communication PageAdapter_communication;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PageAdapter_communication = new PageAdapter_insecure_communication(getSupportFragmentManager(), tabLayout.getTabCount());
